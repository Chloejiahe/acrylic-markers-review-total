...
FEATURE_DIC = {
        ...
        '色彩一致性': {
            ...
            '负面-生产-品控偏差(VS 其他笔)': ['inconsistent batch', 'color varies from pen to pen', 'my new pen is a different shade', 'no quality control', 'batch variation', 'def. different', 'one color was leaking'],
        ...
        '色系评价': {
            ...
            '正面-喜欢鲜艳/高饱和': ['love the vibrant colors', 'love the rich colors', 'love the bold colors', 'love how vivid the colors are', 'highly saturated', 'colors are saturated', 'colors pop', 'really pop', 'makes the colors pop', 'colors really stand out', 'colors jump off the page', 'so full of life'],
            '正面-喜欢粉彩色/柔和系': ['love the pastel colors', 'beautiful pastels', 'adore the soft colors', 'perfect muted tones', 'calming color palette', 'soothing shades', 'gentle on the eyes', 'subtle and elegant', 'love the macaron colors', 'the muted palette is gorgeous', 'macaron colors'],
        ...
        '特殊用途': {
            ...
            '负面-非专业级': ['not professional grade', 'not artist grade', 'hobby grade', 'student grade', 'for hobby use only', 'for casual use only', 'not for serious artists',
                      'feels like a toy', 'not for client work', 'not for commissions','not archival', 'not lightfast', 'more of a toy than a tool',"not for professional art", "not professional grade", "least desired for professional applications", "great for hobbies and amateur use", "perfect for children and casual art", "not for serious artists", "more of a toy than a tool", "not professional quality", "more advanced student", "not a professional artist"],

...
FEATURE_DIC = {
        ...
        '容量': {
            '正面-容量大/耐用': [ 'don\'t dry out easily','haven\'t dried up','large capacity', 'holds a lot of ink', 'lasts long', 'long lasting', 'plenty of ink', 'good amount of ink', 'lasts forever', 'lasts a while', 'doesn\'t run out quickly', 'longevity', 'still going strong after', 'haven\'t run out yet', 'still has ink', 'lots of paint', 'good ink capacity', 'great capacity'],
            ...
            '中性-提到消耗':['i don\'t want to mail them having been opened up for fear they might leak or dry out','without use and not dry out']
        },            
}

...
USER_CATEGORY_MAPPING = {
    'B001AS6P4G': 'posca-(1.85-3.33)-阀门式-8mm-Chisel-15-纸盒-插口盒',
    'B00ZC9JK4Q': 'posca-(1.85-3.33)-阀门式-1.8-2.5mm-Medium-7-纸盒-插口盒',
    'B013NMZ92U': 'posca-(>29.97)-阀门式-0.9-1.3mm-Fine-1-PET插口盒-插口盒',
    'B06ZYTZXG2': 'posca-(1.85-3.33)-阀门式-0.9-1.3mm-Fine-24-纸盒-天地盖硬纸盒',
    'B07D2LC8LH': 'ARTISTRO-(1.17-1.85)-阀门式-0.7mm-Extra Fine-5-纸盒-插口盒',
    'B07NRW6H8M': 'ARTISTRO-(3.33-29.97)-阀门式-0.7mm-Extra Fine-1-纸盒-插口盒',
    'B086XCN9CR': 'AKARUED-(1.17-1.85)-阀门式-2-3mm-Medium-8-PET插口盒-插口盒',
    'B08LTYXQLC': 'ArtShip Design-(3.33-29.97)-阀门式-0.7-2mm-Extra Fine&Medium-2-纸盒-插口盒',
    'B098QPHCVT': 'AKARUED-(1.17-1.85)-阀门式-0.7mm-Extra Fine-8-纸盒-插口盒',
    'B09SWJRSSX': 'JR.WHITE-(0.53-0.79)-阀门式-0.7mm-Extra Fine-18-纸盒-插口盒',
    'B09TR9SD6P': 'SAKEYR-(1.17-1.85)-阀门式-2-3mm-Medium-12-纸盒-插口盒',
    'B09VCYS41G': 'Betem-(0.46-0.53)-棉芯式-1-5mm-Fine&Dot-24-纸盒-插口盒',
    'B0B7VZ9KTJ': 'Artugn-(0.53-0.79)-棉芯式-0.5-5mm-Brush&Fine-24-纸盒-插口盒',
    'B0BN8CW9ZY': 'TANMIT-(0.53-0.79)-棉芯式-1-3mm-Fine&Dot-24-牛津布-布袋',
    'B0C2L17JZB': 'Tesquio-(0.79-1.17)-棉芯式-0.5-5mm-Brush&Dot-8-纸盒-插口盒',
    'B0C61HTPV9': 'SFAIH-(0.53-0.79)-阀门式-3mm-Medium-24-PET插口盒-插口盒',
    'B0CDL915XY': 'SFAIH-(0.79-1.17)-阀门式-0.7-3mm-Extra Fine&Medium-8-纸盒-插口盒',
    'B0CKN74CW3': 'BIGTHUMB-(3.33-29.97)-阀门式-3-15mm-Jumbo-3-纸盒-插口盒',
    'B0CNYV8724': 'TFIVE-(3.33-29.97)-阀门式-0.7mm-Extra Fine-2-纸盒-插口盒',
    'B0CP48JPCH': 'ARTISTRO-(0.46-0.53)-棉芯式-1-5mm-Fine&Dot-24-纸盒-插口盒',
    'B0CQL15B98': 'SFAIH-(0.53-0.79)-阀门式-3mm-Medium-36-PET插口盒-插口盒',
    'B0CX1BD86P': 'TBC The Best Crafts-(<0.37)-棉芯式-1-3.9mm-Brush&Dot-24-纸盒-插口盒',
    'B0CXM7VLXV': 'Droaful-(<0.37)-棉芯式-1-5mm-Brush&Fine-20-纸盒-插口盒',
    'B0CYCCR82G': 'SRUOLOC-(1.85-3.33)-阀门式-3-15mm-Jumbo-3-纸盒-插口盒',
    'B0CYSZ52T4': 'SRUOLOC-(3.33-29.97)-阀门式-3-15mm-Jumbo-1-纸盒-插口盒',
    'B0D21NHYX8': 'SFAIH-(1.17-1.85)-阀门式-2-3mm-Medium-4-纸盒-插口盒',
    'B0D2H7QSX2': 'Coogert-(0.46-0.53)-棉芯式-0.5-5mm-Brush&Fine-30-纸盒-插口盒',
    'B0D471YK2F': 'Oficrafted-(<0.37)-棉芯式-0.3mm-Medium-80-牛津布-拉链式多层布袋',
    'B0D8NGYP76': 'Artecho-(0.42-0.46)-棉芯式-0.5-5mm-Brush&Fine-48-纸盒-插口盒',
    'B0DFMRDMNJ': 'REALZEVA-(<0.37)-阀门式-1-3mm-Fine&Dot-24-纸盒-插口盒',
    'B0DJBS38PR': 'Amamao-(0.46-0.53)-直液式-1-5mm-Brush-120-纸盒-天地盖硬纸盒',
    'B0DKFMN8HF': 'AKARUED-(>29.97)-棉芯式-1mm-Brush&Fine-6-纸盒-插口盒',
    'B0DL9ZPMLX': 'Recheel-(<0.37)-棉芯式-1-5mm-Brush&Fine-30-纸盒-插口盒',
    'B0DLKVD4TW': 'nauets-(0.53-0.79)-棉芯式-1-5mm-Fine&Dot-30-纸塑结合包装-插口盒',
    'B0DMNY5C69': 'TOSHARE-(>29.97)-棉芯式-1-5mm-Brush&Fine-30-纸盒-插口盒',
    'B0DQX43YQD': 'TBC The Best Crafts-(>29.97)-棉芯式-1-3.9mm-Brush&Dot-1-牛津布-拉链式多层布袋',
    'B0DRFG52NK': 'IVSUN-(0.53-0.79)-棉芯式-0.5-5mm-Brush&Fine-30-纸盒-插口盒',
    'B0DS1NZD89': 'HOTU-(>29.97)-直液式-0.7-6mm-Brush-36-纸盒-天地盖硬纸盒',
    'B0F5WMP62Z': 'Coogert-(<0.37)-棉芯式-1-5mm-Fine&Dot-24-纸盒-插口盒',
    'B0F66RVHJW': 'Overseas-(>29.97)-直液式-0.1-5mm-Brush-60-纸盒-插口盒'

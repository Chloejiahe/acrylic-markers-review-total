...
FEATURE_DIC = {
        ...
        '色系评价': {
            ...
            '负面-显色偏差/严重色差': ["more pastel than bold", "different shade", "completely opposite", "darker pink was very pastel", "not bold as expecting", "hue is off", "ROYGBIV hue is off", "brighter hue", "color is off", "not match cap color", "cap color not accurate", "red is very orange-red", "pink is actually light pink", "not a real pink", "greyish tone", "greenish tone", "dull red", "pale white", "watery white", "muted colors", "low pigmentation", "poor color saturation", "inconsistent hue", "faded shades", "dull and boring", "darkish pink", "not true brown", "not true navy blue", "pink without depth", "color is washed out",  "weak white", "blues are more like turquoise or seafoam","thinner side and thicker side colors may not be the same","wide tip is a lighter version in color","color names are really off from what they actually are","army green is almost gray","no rich dark colors like forest green, wine","all the pink/oranges are similar","several colors that are almost the same", "red isn’t red at all, it’s coral","red is more of a rose color","red is a brink pink-red","the greens have a lot of blue in them", "red is orange",'green leans to teal','colors dont look like the color it’s supposed to be','colors are different when using the other end',"brown is opaque dull color","two purples are hard to distinguish","orange comes across as a salmon","green looks yellow green",'red is a dark pink', 'green is a dark teal', 'the green is more like turquoise', 'red is very pale like pink', 'some colors are not true colors', 'there's no true red color', 'only orange ones that are clearly not red', 'the yellow is almost too sheer', 'orange is not a traditional orange', 'the red that I have looks bright pink', 'colors are equally diluted', 'light blue is more greenish', 'flat, non-vibrant colors', 'color of pen doesn't show unless I do a second layer','more gold in them than the actual color','looked rather washed out','the white kept being picked up','started to turn gray instead of white','the white is not that white','the ink was super milky and too transparent','not as vibrant as I thought','not as bold as I hoped','white is not that white','not as opaque as I would like','The white color doesn't completely cover','white is barely visible','light purple was a dud',"colors not opaque enough",'sky blue is transparent','sky blue is watery','paint is not as bright as I expected','orange is a more reddish orange','the bright yellow color is actually a true orange','red is not a stark bright red','not as bright as pictured','RED markers AREN\'T RED','light blue is complete watered down', 'red was definitely more on the pink side', 'red look more like coral', 'color not what I needed', 'not a bright white', 'white is barely white', 'discolored lines', 'looked rather washed out', 'faint on the rock art','barely shows up'],

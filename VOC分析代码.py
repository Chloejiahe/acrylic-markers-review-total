...
FEATURE_DIC = {
        ...
        '色系评价': {
            ...
            '正面-喜欢中性/肤色系': ['love the skin tones', 'great range of skin tones', 'perfect for portraits', 'excellent for portraiture', 'realistic skin tones', 'beautiful flesh tones', 'wide variety of skin colors', 'perfect neutral palette', 'love the neutral colors', 'great selection of neutrals', 'beautiful earth tones'],
            '正面-喜欢大地/自然色系': ['love the earth tones', 'adore the earthy palette', 'beautiful natural colors', 'gorgeous nature-inspired colors', 'love the botanical colors', 'perfect botanical palette', 'beautiful forest greens', 'love the sage green', 'terracotta shades'],
            ...
            '正面-喜欢霓虹/荧光/夜光': ["glow pretty bright under blacklight", "UV reactive looks rad", "glow in the dark", "react under UV", "glow under blacklight", "really pop under blacklight", "fluorescent neon", "glow in the dark, and they work wonderfully", "so bright", "glow is vibrant", "great blacklight reactive paint", "show up well under blacklight", "very bright under blacklight", "quite bright under uv flashlight",'love the neon colors', 'super bright neon', 'the neon really pops', 'vibrant neon shades', 'glows under blacklight', 'perfect for blacklight art', 'glow pretty bright under blacklight', 'colors glow in the dark', 'UV art'],
            '正面-喜欢金属/珠光/亮片系': ["love the metallic ones", "great metallic ones",'this ink is not glitter. it is simply metallic','they seem more metalic than glitter','love the metallic colors', 'great metallic effect', 'beautiful metallic sheen', 'shiny metal finish', 'gorgeous chrome finish', 'looks like real metal', 'love the pearlescent finish', 'beautiful shimmer', 'amazing liquid chrome effect', 'very reflective', 'stunning iridescent colors', 'love the lustre', 'metallic/ glittery', 'too sparkly', 'glitter lover', 'amazing after sealing with clear glaze'],
            '负面-显色偏差/严重色差': [
                "more pastel than bold", "different shade", "completely opposite", "darker pink was very pastel", 
                "not bold as expecting", "hue is off", "ROYGBIV hue is off", "brighter hue", "color is off", 
                "not match cap color", "cap color not accurate", "red is very orange-red", "pink is actually light pink", 
                "not a real pink", "greyish tone", "greenish tone", "dull red", "pale white", "watery white", 
                "muted colors", "low pigmentation", "poor color saturation", "inconsistent hue", "faded shades", 
                "dull and boring", "darkish pink", "not true brown", "not true navy blue", "pink without depth", 
                "color is washed out", "weak white", "blues are more like turquoise or seafoam", 
                "thinner side and thicker side colors may not be the same", "wide tip is a lighter version in color", 
                "color names are really off from what they actually are", "army green is almost gray", 
                "no rich dark colors like forest green, wine", "all the pink/oranges are similar", 
                "several colors that are almost the same", "red isn’t red at all, it’s coral", 
                "red is more of a rose color", "red is a brink pink-red", "the greens have a lot of blue in them", 
                "red is orange", "green leans to teal", "colors dont look like the color it’s supposed to be", 
                "colors are different when using the other end", "brown is opaque dull color", 
                "two purples are hard to distinguish", "orange comes across as a salmon", 
                "green looks yellow green", "red is a dark pink", "green is a dark teal", 
                "the green is more like turquoise", "red is very pale like pink", "some colors are not true colors", 
                "there's no true red color", "only orange ones that are clearly not red", 
                "the yellow is almost too sheer", "orange is not a traditional orange", 
                "the red that I have looks bright pink", "colors are equally diluted", 
                "light blue is more greenish", "flat, non-vibrant colors", 
                "color of pen doesn't show unless I do a second layer", "more gold in them than the actual color", 
                "looked rather washed out", "the white kept being picked up", "started to turn gray instead of white", 
                "the white is not that white", "the ink was super milky and too transparent", 
                "not as vibrant as I thought", "not as bold as I hoped", "white is not that white", 
                "not as opaque as I would like", "The white color doesn't completely cover", 
                "white is barely visible", "light purple was a dud", "colors not opaque enough", 
                "sky blue is transparent", "sky blue is watery", "paint is not as bright as I expected", 
                "orange is a more reddish orange", "the bright yellow color is actually a true orange", 
                "red is not a stark bright red", "not as bright as pictured", "RED markers AREN'T RED", 
                "light blue is complete watered down", "red was definitely more on the pink side", 
                "red look more like coral", "color not what I needed", "not a bright white", 
            ...
            '负面-色系搭配/质量评价': [
                "no real brown", "no deep colors", "not many deep colors", "phatlo type colors", 
                "triplicates of some colors", "no greens", "no true red", "no standard red", 
                "no blue", "no purples", "limited dark shades", "poor variety of colors", 
                "color range is uneven", "lots of pinks few greens", "color selection could be better", 
                "not enough browns", "only one brown", "too many purples", "too many greens", 
                "too many yellows", "limited color range", "color is limited", "no proper brown", 
                "no true dark pink", "no hot pink", "no neon pink", "duplicate light pink", 
                "lack of darker shades", "lack of vibrant shades", "odd color selection", 
                "color assortment is limited", "need more color options", 
                "none of them other than white and black are really what I'd expect", 
                "missing rich dark colors", "colors could vary a little more", 
                "not enough color variety", "colors aren’t as deep as I prefer", 
                "not enough distinct colors", "lack of primary colors", "missing basic shades", 
                "no true red or orange if you are looking for that", "duplicate ones of the same colors", 
                "only one bright red", "the color selection is not that great", 
                "the colors of these pens are NOT basic", "no standard blue or green", 
                "the green is not a kelly green but a dark hunter green", 
                "the only basic colors in this set are black and white", 
                "the set doesn't have a deep red color", 
                "no assortment of basics (like a true red, navy, etc.)", 
                "the green colors aren't even actually green", "they're just darker blues", 
                "lack of every color", "there is no true brown or red", "the green is not a kelly green", 
                "wish I had some more colors", "color selection is a little bland", 
                "colors in this pack aren't that useful for normal coloring pages", 
                "missing critical shades: beige, tan, warm grays", "brown leans orange-red", 
                "weird color combination", "terrible color choices", "Too many neon colors", 
                "bad color selection", "they kinda all look the same", "not all of the white markers are white", 
                "no white included", "missing basic colors", "limited without neutrals", 
                "only pastel colors", "no black included", "palette is ugly", 
                "colors don't go well together", "weird color combination", "unusable colors in set", 
                "poorly curated", "terrible color choices", "bad color selection", 
                "the colors clash", "no color harmony", "not a cohesive palette", 
                "colors are jarring", "dark and light colors"
            ],
        ...
        '外观与包装': {
            '正面-外观/设计美观': ['beautiful design', 'minimalist design', 'sleek design', 'clean design', 'well-designed','thoughtful design', 'love the design', 'love the look of', 'pleasing aesthetic', 'looks elegant', 'high-end look', 'modern look', 'looks professional', 'impressed with the design',"visual appeal is great","professionally designed", "love the transparent section" ],
            ...
            '负面-标签与真伪争议 (针对海外版/进口版)': ['everything written in Chinese', 'all writing is Asian', 'Japanese import labels', 'no English or French on packaging', 'does not conform to packaging laws', 'writing on the sides came in Japanese', 'different from the pictures shown','looks like a knock off', 'off brand items'],
            '正面-收纳便利': ["easy to store", "convenient for carrying", "pens stay in place", "organized neatly in the box", "easy to keep track of colors", "storage is convenient",'well-organized', 'keeps them neat', 'keeps them organized', 'easy to organize', 'easy access to colors', 'easy to find the color', 'easy to get pens out', 'convenient storage', 'handy case', 'sturdy case', 'nice carrying case', 'protective case', 'pens fit perfectly', 'individual slots for each pen', 'great storage box', 'useful pen holder'],
        ...
        '多样性与适配性': {
            '正面-用途广泛': [ 'great for many different projects', 'works on a variety of surfaces', 'use on various surfaces', 'multi-surface use', 'use for a variety of projects', 'perfect for all sorts of projects','multi-purpose', 'all-in-one', 'jack of all trades', 'works for everything','use it for everything', 'handles a variety of tasks', 'works on multiple surfaces',
                      'use on different surfaces', 'good for many different projects', 'one set for all my needs','great for both drawing and writing'],
            '负面-用途单一': ['not meant for all surfaces', 'limited use on certain materials','not versatile', 'lacks versatility', 'not multi-purpose', 'single-purpose', 'single use','one-trick pony', 'limited use', 'very limited in its use', 'limited application',  'only for paper', 'only works on paper', 'doesn\'t work on other surfaces',
